...
const url = `https://single-spa-demo-femiarkh.s3.eu-west-1.amazonaws.com/%40femiarks/nav/${process.env.TRAVIS_COMMIT}/femiarks-single-spa-demo-nav.js`;
  ...
  .get(url, (res) => {
    ...
    if (res.statusCode >= 200 && res.statusCode < 300) {
      if (
        ...
        const moduleName = `@femiarks/single-spa-demo-nav`;
